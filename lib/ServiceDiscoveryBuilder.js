...
ServiceDiscoveryBuilder.prototype.staleNodeTimeDiff = function (lastUpdatedTimeDiff) {
    this.serviceDiscovery.staleNodeTimeDiff = lastUpdatedTimeDiff;
    return this;
};
...
ServiceDiscoveryBuilder.prototype.build = function () {
    return new ServiceDiscovery(
        ...
        this.serviceDiscovery.staleNodeTimeDiff);
};
